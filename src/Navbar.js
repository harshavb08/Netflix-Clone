...
function Navbar() {
    ...
    return (
        <div className={`navbar ${offset && "nav__black"}`}>
            <img className="navbar__logo" alt="Netflix logo" src="https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg"/>
